...
export function checkWinner(board: Board, mode: GameMode): { 
...
// Новая функция для определения, кто должен ходить следующим
export function getNextPlayer(currentPlayer: "X" | "O"): "X" | "O" {
  return currentPlayer === "X" ? "O" : "X"
}

// Функция для проверки, может ли игрок сделать ход
export function canPlayerMove(board: Board, playerSymbol: "X" | "O", currentPlayer: "X" | "O"): boolean {
  return currentPlayer === playerSymbol && board.some(cell => cell === null)
}
